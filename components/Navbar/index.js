                ...
                <div className="h-11 w-full shadow-lg pt-3 bg-white rounded-3xl">
                    <label className="w-full block pl-5">
                        <div className="inline">
                            ...
                            >
                                <svg
                                    className="block fill-current h-4 w-4  stroke-current stroke-4 overflow-visible"
                                    viewBox="0 0 32 32"
            ...
            <div className="items-center justify-between h-full px-10 lg:px-20 hidden md:flex">
                ...
                >
                    <ul>
                        ...
                        <li className="inline p-3 hover:bg-gray-100 hover:bg-opacity-20 rounded-full mr-2">
                        ...
                        <li className="inline p-3 bg-white rounded-3xl">
                            <button className="h-12 leading-none focus:outline-none">
                                <div className="inline text-black">
                                    <svg
                                        className=" text-black inline w-4 h-4 -mt-1 stroke-current stroke-2 overflow-visible"
                                        fill="none"
                                        viewBox="0 0 32 32"
                                ...
                                <div className="inline text-gray-500">
                                    <svg
                                        className="inline ml-5 h-8 w-8 -mt-1 fill-current"
                                        viewBox="0 0 32 32"
                                        xlmns="http://www.w3.org/2000/svg"
                                        aria-hidden="true"
                                        role="presentation"
